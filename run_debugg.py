...
from kalman_filter_real_time import *
...
class Path:
    def __init__(self):
        dir_path = 'routes_data/SPKT_map.csv'
...
class Car:
    ...
    def drive(self,lock):
        ...
        #self.x, self.y, self.yaw = run_rlt(gps,raw_yaw,self.pyaw)
        ...
        with open('sensor_log/eyaw.txt', 'w') as temp_file:
